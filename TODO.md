...
| [GNOME Snapshot !464](https://gitlab.gnome.org/GNOME/snapshot/-/merge_requests/464) | `aperture: Set min-buffers to 8 on the pipewiresrc` | 🔵 **deschis**, al lui `msandova`, neatins din 8 aug. E un ocol **în partea de Snapshot** pentru o cauză care era în PipeWire; după !2935 (în master din 9 sep) probabil nu mai e necesar, dar **asta n-a fost verificat pe hardware**, deci nu se afirmă nicăieri |
