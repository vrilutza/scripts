...
| [pipewire !3013](https://gitlab.freedesktop.org/pipewire/pipewire/-/merge_requests/3013) | `mmap_read()` folosea fără verificare indexul de la `VIDIOC_DQBUF`; un driver neconform (v4l2loopback) dărâma daemonul | 🔵 **deschis 19 sep**, CI 62/62. Primul review (`pobrn`, pe comentariul din cod: e un ocol pentru un driver neconform): comentariul și mesajul reformulate (`d66a53705`, CI 62/62) și răspuns în firul lui |
| [v4l2loopback #659](https://github.com/v4l2loopback/v4l2loopback/pull/659) | PR-ul lor: DQBUF conform V4L2 | 💬 comentariul nostru din 19 sep: head-ul lor testat; căderea PipeWire dispare cu el |
| [pipewire #5481](https://gitlab.freedesktop.org/pipewire/pipewire/-/work_items/5481) | Range×Range: consumatorul cere 16, dispozitivul dă 8, rezultatul cade la 4 în loc de 8 | 🔵 **deschis 19 sep**, întrebare de politică, cu reproducere în C; fără patch |
